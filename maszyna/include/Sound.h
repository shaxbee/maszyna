...
public:
 ...
 LPDIRECTSOUNDBUFFER __fastcall GetUnique(LPDIRECTSOUND8 pDS8);
 __fastcall TSoundContainer(LPDIRECTSOUND8 pDS8, char *Directory, char *strFileName, int NConcurrent);
