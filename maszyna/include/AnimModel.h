...
public:
    ...
    bool __fastcall Init(std::string asName, std::string asReplacableTexture);
    ...
    bool __fastcall Render(vector3 pPosition= vector3(0,0,0), double fAngle= 0, TGroundNode *gn=NULL);
