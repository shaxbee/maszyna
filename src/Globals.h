...
class Global
{
  ...
  public:
    ...
    static vector3 pCameraPosition; // pozycja kamery w świecie
    static double
    ...
    static double fCalibrateIn[6][4];    // parametry kalibracyjne wejść z pulpitu
    static double fCalibrateOut[7][4];   // parametry kalibracyjne wyjść dla pulpitu
